...
def main():
    ...
    base_path = "/mnt/Data02/project/experiment/monai/"
    raw_data_base_dir = os.path.join(base_path, "orig_datasets")  # the directory of the raw images
    resampled_data_base_dir = os.path.join(base_path, "datasets")  # the directory of the resampled images
    downloaded_datasplit_dir = os.path.join(base_path, "LUNA16_datasplit")  # the directory of downloaded data split files

    out_trained_models_dir = os.path.join(base_path, "trained_models")  # the directory to save trained model weights
    out_tensorboard_events_dir = os.path.join(base_path, "tfevent_train")  # the directory to save tensorboard training curves
    out_inference_result_dir = os.path.join(base_path, "result")
